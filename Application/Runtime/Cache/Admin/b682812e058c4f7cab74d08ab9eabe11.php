...
<head>
    ...
    <link href="/wenjiangongxiang/Public/css/UserCSS.css" rel="stylesheet" type="text/css" />
    <script src="/wenjiangongxiang/Public/js/jquery.min.js" type="text/javascript"></script>
    <script src="/wenjiangongxiang/Public/js/ops.js" type="text/javascript"></script>
    <script src="/wenjiangongxiang/Public/js/UserJS.js" type="text/javascript"></script>
</head>
<body>
        ...
        <div class="u-menu">
            <ul class="u-nav" id="user_menu">
                <li class="item" id="user_menu_my" name="user_menu_my">
                    ...
                    <ul class="sub">
                        <li><a class="current" href="/wenjiangongxiang/index.php/Admin/Admin/index">个人主页</a></li>
                        <li><a href="/wenjiangongxiang/index.php/Admin/Admin/personal">个人资料</a></li>
                        <li><a href="/wenjiangongxiang/index.php/Admin/Admin/information">认证管理</a></li>
                    </ul>
                </li>
                <li class="item" id="user_menu_funds" name="user_menu_funds">
                    ...
                    <ul class="sub">
                         <li><a href="/wenjiangongxiang/index.php/Admin/Admin/capital">资金记录</a></li>
                    </ul>
                </li>
                <li class="item" id="user_menu_invest" name="user_menu_invest">
                    ...
                    <ul class="sub">
                       <li><a href="/wenjiangongxiang/index.php/Admin/Admin/investment">我的投资</a></li>
                    </ul>
                </li>
                <li class="item" id="user_menu_loan" name="user_menu_loan">
                    ...
                    <ul class="sub">
                        <li><a  href="/wenjiangongxiang/index.php/Admin/Admin/loan">我的贷款</a></li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="ucenter">
                <div class="ucenter-info mt10">
                    ...
                    <div class="info">
                        <ul class="info-img">
                            <li>
                                <img src="/wenjiangongxiang/Public/images/tx_img.gif" class="avatar" /></li></ul>
                        <div class="info-main">
                            <div class="row">
                                <label>
                                    用户名：</label>张三</div>
